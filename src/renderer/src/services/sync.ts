...
export async function startSync(): Promise<() => void> {
  ...
  const live = <K extends 'rack' | 'settings' | 'lock' | 'licence' | 'legal' | 'update'>(key: K) =>
